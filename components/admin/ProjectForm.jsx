    ...
    return (
        <form onSubmit={onSubmit} noValidate className="max-w-4xl space-y-10">
            {summary && (
                <p
                    role="alert"
                    className="label-mono border-l-2 border-signal py-1 pl-3 text-signal"
                >
                    {summary}
                </p>
            )}
            ...
            >
                ...
                <Field
                    ...
                    htmlFor="animationTrigger"
                    error={errors.animationTrigger}
                >
                    <Select
                        id="animationTrigger"
                ...
                <Field label="Display order" htmlFor="displayOrder" error={errors.displayOrder}>
                    <NumberInput
                        ...
                        onChange={(e) =>
                            set("displayOrder")(e.target.value === "" ? 0 : Number(e.target.value))
                        }
                    />
                </Field>
