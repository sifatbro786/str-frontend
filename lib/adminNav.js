...
export const ADMIN_NAV = [
    ...
    /* Sits under Services because that is what it prices. It is one screen with
       three tabs — tracks, packages, page copy — for the same reason
       /admin/site-content is one screen: they are always edited together. */
    { href: "/admin/packages", label: "Packages", icon: PackagesIcon, group: "Content" },
