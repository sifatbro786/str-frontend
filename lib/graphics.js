 ...
 * lib/utils mediaUrl untouched and next/image optimises them locally. When the
 ...
 *   receive     what is handed over. Chips, same idiom as the portfolio cards
...
export const GRAPHICS_SERVICES = [
    {
        ...
        hero: {
            before: "/graphics/clippingPathBefore1.jpg",
            after: "/graphics/clippingPathAfter1.jpg",
            caption: "014A",
        },
        support: [
            {
                before: "/graphics/clippingPathBefore2.jpg",
                after: "/graphics/clippingPathAfter2.jpg",
                caption: "014B",
            },
            {
                before: "/graphics/clippingPathBefore3.jpg",
                after: "/graphics/clippingPathAfter3.jpg",
                caption: "014C",
            },
        ],
    },
    {
        ...
        hero: {
            before: "/graphics/backgroundRemovalBefore1.jpg",
            after: "/graphics/backgroundRemovalAfter1.jpg",
            caption: "022A",
        },
        support: [
            {
                before: "/graphics/backgroundRemovalBefore2.jpg",
                after: "/graphics/backgroundRemovalAfter2.jpg",
                caption: "022B",
            },
            {
                before: "/graphics/backgroundRemovalBefore3.jpg",
                after: "/graphics/backgroundRemovalAfter3.jpg",
                caption: "022C",
            },
        ],
    },
    {
        ...
        hero: {
            before: "/graphics/maskingBefore1.jpg",
            after: "/graphics/maskingAfter1.jpg",
            caption: "031A",
        },
        support: [
            {
                before: "/graphics/maskingBefore2.jpg",
                after: "/graphics/maskingAfter2.jpg",
                caption: "031B",
            },
            {
                before: "/graphics/maskingBefore3.jpg",
                after: "/graphics/maskingAfter3.jpg",
                caption: "031C",
            },
        ],
    },
    {
        ...
        hero: {
            before: "/graphics/mannequinBefore1.jpg",
            after: "/graphics/mannequinAfter1.jpg",
            caption: "040A",
        },
        support: [
            {
                before: "/graphics/mannequinBefore2.jpg",
                after: "/graphics/mannequinAfter2.jpg",
                caption: "040B",
            },
            {
                before: "/graphics/mannequinBefore3.jpg",
                after: "/graphics/mannequinAfter3.jpg",
                caption: "040C",
            },
        ],
    },
    {
        ...
        mode: "static",
        hero: { src: "/graphics/colorProcessing.jpg", caption: "057" },
        support: [],
    },
    {
        id: "retouching",
        ...
        hero: {
            before: "/graphics/retouchingBefore1.jpg",
            after: "/graphics/retouchingAfter1.jpg",
            caption: "063A",
        },
        support: [
            {
                before: "/graphics/retouchingBefore2.jpg",
                after: "/graphics/retouchingAfter2.jpg",
                caption: "063B",
            },
            {
                before: "/graphics/retouchingBefore3.jpg",
                after: "/graphics/retouchingAfter3.jpg",
                caption: "063C",
            },
        ],
    },
    {
        ...
        hero: {
            before: "/graphics/shadowBefore1.jpg",
            after: "/graphics/shadowAfter1.jpg",
            caption: "074A",
        },
        support: [
            {
                before: "/graphics/shadowBefore2.jpg",
                after: "/graphics/shadowAfter2.jpg",
                caption: "074B",
            },
            {
                before: "/graphics/shadowBefore3.jpg",
                after: "/graphics/shadowAfter3.jpg",
                caption: "074C",
            },
        ],
    },
    {
        ...
        mode: "static",
        hero: { src: "/graphics/croppingImage.jpg", caption: "081A" },
        support: [],
    },
];
...
export const GRAPHICS_HERO = {
    before: "/graphics/heroBefore1.jpg",
    after: "/graphics/heroAfter1.jpg",
 ...
 *
 * Returns the rows in the order they are priced rather than the order they run
 * in, cheapest first, because a rate table is read as a price list and a price
 * list that is not sorted looks arbitrary. `position` carries the pipeline
 * number across so the table and the sections below it still line up.
 */
...
/**
 * USD, and deliberately not Intl.NumberFormat's default.
 *
 * These are sub dollar rates, so the default two digit currency format gives
 * "$0.20" for most of the table and "$1.00" for one row, which is correct and
 * reads as a rounding artefact. Cents are printed as cents and whole dollars
 * as dollars, which is how the studio quotes them out loud.
 */
