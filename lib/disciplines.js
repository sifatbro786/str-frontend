/**
 * Catalogue taxonomy — enums, labels and the per-discipline verbs.
 *
 * Kept apart from lib/catalogue.js for the same reason lib/taxonomy.js is
 ...
 *
 * ⚑ When the catalogue moves behind the dashboard, these five ids become the
