...
/* SERVICE_TYPES is gone — the taxonomy is the Service collection now, read
   through getServices(). Re-exporting a binding that no longer exists is a
   build error the moment anything imports this module, so the list is not
   replaced by a local copy here. See lib/taxonomy.js. */
export { SERVICE_LABELS, serviceLabel, serviceOptions } from "./taxonomy";
...
<h2>Where it landed</h2><p>Time to interactive on a throttled 3G profile fell from 11.2s to 4.3s. Checkout completion rose 23% over the first eight weeks. Catalogue publishing, previously a developer task, moved to the merchandising team.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/websites/paarel-website.webp",
        thumbnailImage: "/websites/paarel-website.webp",
        galleryImages: [
            {
                url: "/websites/paarel-website.webp",
                caption: "Storefront home, dark surface",
                layoutType: "full",
            },
            {
                url: "/websites/vera-website.webp",
                caption: "Category rail and filter drawer",
                layoutType: "half",
            },
            {
                url: "/websites/zuzuva-website.webp",
        ...
        ogImage: "/websites/paarel-website.webp",
...
<h2>Result</h2><p>Quote turnaround dropped from roughly a day to under twenty minutes, and stock disputes effectively stopped.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/websites/innoel-website.webp",
        thumbnailImage: "/websites/innoel-website.webp",
        galleryImages: [
            {
                url: "/websites/innoel-website.webp",
                caption: "Catalogue landing",
                layoutType: "full",
            },
            {
                url: "/websites/skhsourcing-website.webp",
        ...
        ogImage: "/websites/innoel-website.webp",
...
<h2>Outcome</h2><p>Direct bookings grew from a small fraction of departures to the majority, and the manual reconciliation spreadsheet was retired.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/websites/tigerdentourism-website.webp",
        thumbnailImage: "/websites/tigerdentourism-website.webp",
        galleryImages: [
            {
                url: "/websites/tigerdentourism-website.webp",
                caption: "Departure detail page",
                layoutType: "full",
            },
            {
                url: "/websites/riverside-website.webp",
                caption: "Itinerary builder",
                layoutType: "half",
            },
            {
                url: "/websites/the-foxes-website.webp",
        ...
        ogImage: "/websites/tigerdentourism-website.webp",
...
<h2>Result</h2><p>Invoicing moved from monthly to same-week. Disputed jobs fell sharply once every completion carried a timestamped photo.</p>`,
        ...
        coverImage: "/websites/torgeson-website.webp",
        thumbnailImage: "/websites/torgeson-website.webp",
        galleryImages: [
            {
                url: "/websites/torgeson-website.webp",
                caption: "Supervisor dashboard",
                layoutType: "full",
            },
            { url: "/PPhoto.png", caption: "Technician job view", layoutType: "grid" },
            { url: "/websites/teds-website.webp", caption: "Evidence capture", layoutType: "grid" },
            { url: "/websites/vera-website.webp", caption: "Scheduling board", layoutType: "grid" },
        ],
        accentColor: "#1476BE",
        layoutStyle: "split",
        ...
        ogImage: "/websites/torgeson-website.webp",
...
<h2>Outcome</h2><p>The sales team ran the entire pre-launch on this package with no site photography at all.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/2d-3d/3d-rendering.webp",
        thumbnailImage: "/2d-3d/3d-floor-plan.webp",
        galleryImages: [
            { url: "/2d-3d/3d-rendering.webp", caption: "Exterior, dusk study", layoutType: "full" },
            {
                url: "/2d-3d/2d-floor-plan-colour.webp",
                caption: "Coloured 2D plan — Type A",
                layoutType: "grid",
            },
            {
                url: "/2d-3d/2d-floor-plan-mono.webp",
                caption: "Monochrome plan for print",
                layoutType: "grid",
            },
            {
                url: "/2d-3d/2d-floor-plan-dual-unit.webp",
                caption: "Dual-unit floor plate",
                layoutType: "grid",
            },
            { url: "/2d-3d/3d-interior.webp", caption: "Living room, Type B", layoutType: "half" },
            {
                url: "/2d-3d/exterior-lighting.webp",
                caption: "Facade lighting study",
                layoutType: "half",
            },
            {
                url: "/2d-3d/3d-animation-video.webp",
        ...
        ogImage: "/2d-3d/3d-rendering.webp",
...
<h2>Result</h2><p>Rejection rate at the client's end settled under 1.2%, and no weekly drop was missed.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/graphics/invisible-mannequin.webp",
        thumbnailImage: "/graphics/clipping-path.webp",
        galleryImages: [
            {
                url: "/graphics/invisible-mannequin.webp",
                caption: "Ghost mannequin composite",
                layoutType: "half",
            },
            { url: "/graphics/clipping-path.webp", caption: "Hand-drawn path", layoutType: "half" },
            {
                url: "/graphics/image-masking.webp",
                caption: "Channel mask — knitwear",
                layoutType: "grid",
            },
            { url: "/graphics/retouching.webp", caption: "Retouch pass", layoutType: "grid" },
            {
                url: "/graphics/shadows-reflection.webp",
                caption: "Shadow rebuild",
                layoutType: "grid",
            },
            {
                url: "/graphics/color-processing.webp",
        ...
        ogImage: "/graphics/invisible-mannequin.webp",
...
<h2>Result</h2><p>Completion on the donation flow roughly doubled, and average gift size rose once monthly giving was made the default option.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/websites/london-youth-website.webp",
        thumbnailImage: "/websites/london-youth-website.webp",
        galleryImages: [
            { url: "/websites/london-youth-website.webp", caption: "Home", layoutType: "full" },
            {
                url: "/websites/the-foxes-website.webp",
            ...
            {
                url: "/websites/podcast-website.webp",
        ...
        ogImage: "/websites/london-youth-website.webp",
...
<h2>Result</h2><p>Cost per qualified lead fell 44% over the following quarter, on flat spend.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/websites/terea-website.webp",
        thumbnailImage: "/websites/terea-website.webp",
        galleryImages: [
            {
                url: "/websites/terea-website.webp",
                caption: "Landing page system",
                layoutType: "full",
            },
            { url: "/digital/seo-audit-report.webp", caption: "Audit extract", layoutType: "half" },
            {
                url: "/digital/facebook-ads-campaign.webp",
        ...
        ogImage: "/websites/terea-website.webp",
...
<h2>Result</h2><p>Front-desk call volume dropped by roughly half within a month, and no-shows fell once deposits were attached to bookings.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/websites/australian-cosmetic-website.webp",
        thumbnailImage: "/websites/australian-cosmetic-website.webp",
        galleryImages: [
            {
                url: "/websites/australian-cosmetic-website.webp",
                caption: "Clinic home",
                layoutType: "full",
            },
            { url: "/websites/vera-website.webp", caption: "Booking step", layoutType: "half" },
            { url: "/websites/teds-website.webp", caption: "Treatment library", layoutType: "half" },
        ],
        accentColor: "#57B04A",
        layoutStyle: "full-width",
        animationTrigger: "fade-up",
        ...
        ogImage: "/websites/australian-cosmetic-website.webp",
...
<h2>Result</h2><p>Largest contentful paint settled at 1.1s. Enquiries through the site tripled in the first quarter.</p>`,
        ...
        appStoreUrl: "",
        playStoreUrl: "",
        coverImage: "/websites/the-foxes-website.webp",
        thumbnailImage: "/websites/the-foxes-website.webp",
        galleryImages: [
            { url: "/websites/the-foxes-website.webp", caption: "Home", layoutType: "full" },
        ...
        ogImage: "/websites/the-foxes-website.webp",
...
<h2>The gate matters more than the pipeline</h2><p>One QC pass before batching, done by someone who did not do the retouching, catches the overwhelming majority of what a client would otherwise reject. It costs a fraction of a re-delivery.</p>`,
        coverImage: "/graphics/retouching.webp",
        author: AUTHOR_SM,
        category: "Production",
...
<h2>Then prune ruthlessly</h2><p>Once cost per qualified lead is visible per campaign, the decision usually makes itself. In most accounts we audit, a minority of campaigns produce nearly all of the qualified pipeline.</p>`,
        coverImage: "/digital/seo-audit-report.webp",
        author: AUTHOR_ARIF,
        category: "Growth",
...
<h2>And deliver both colour spaces</h2><p>Print CMYK and web sRGB from the same master. A marketing team re-exporting your files is a marketing team introducing errors into your work.</p>`,
        coverImage: "/2d-3d/3d-interior.webp",
        author: AUTHOR_SM,
