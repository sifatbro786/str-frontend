...
export const privacyPolicy = {
    ...
    summary: [
        ...
        "Nothing that measures or tracks you runs until you accept the cookie banner.",
    ...
    sections: [
        ...
        },
        {
            ...
            blocks: [
                "This site runs Google Tag Manager, which is the container our measurement tags are configured in. It loads on every public page, but it loads with every storage category switched off: until you press Accept on the banner, no tag inside it may write a cookie, read an advertising identifier or store anything that could identify you. If you decline, or simply ignore the banner, it stays switched off — Google receives an anonymous, cookieless signal that a page was viewed, and nothing that links that page view to you, to your device or to a previous visit.",
                "There is no session recorder and no A/B testing script. Setting aside what Tag Manager may store after you accept, the following is everything this site keeps in your browser, all of it readable only by us.",
                {
                    defs: [
                        {
                ...
                "Everything in that list is strictly necessary or set only after you sign in, so the site works identically whether you accept or decline. Declining costs you nothing, which is the point, and you can change your answer at any time from the cookie settings link at the end of this page.",
                {
                    note: "If we add a tag that needs more than the categories described here, this section is updated before it ships, and your existing consent choice is never quietly widened to cover it.",
                },
            ],
        },
        {
                ...
                "We do not sell personal information, we do not share it with advertisers, and we do not trade contact lists. A small number of infrastructure providers process data on our behalf, under contract, because the site cannot run without them.",
                {
                    defs: [
                        ...
                        },
                        {
                            ...
                            desc: "Serves the measurement container described above. Because your browser loads it directly, Google sees your IP address and user agent on every page view. Before you accept the banner, that is all it receives — no cookie is set and no advertising identifier is read.",
                        },
                        {
                            term: "Fontshare",
