...
/* Client logos in /public/logo/partners. Real files — verified on disk.
   ...
   `work` is the label PartnersBand reveals under the logo on hover; `sector`
   is the grouping the caption promises ("construction, retail, media & export").

   ⚑ Both are reconstructed from each client's own line of business — plausible,
   not sourced from a contract. Confirm every one with the account owner before
   launch: a wrong project label under a real client's logo is worse than no
   label at all.

   `href` is optional. Give a partner one and PartnersBand upgrades that cell to
   a real case-study link with the "view" cursor; without it the cell stays
   non-interactive and the badge alone does the talking. */
export const partners = [
  { name: "AECL", logo: "/logo/partners/aecl-logo.png", sector: "Construction", work: "Project control dashboard" }, // ⚑
  { name: "Bay Developments", logo: "/logo/partners/bay-logo.png", sector: "Real estate", work: "Property sales portal" }, // ⚑
  { name: "GSP", logo: "/logo/partners/gsp-logo.png", sector: "Logistics", work: "Shipment tracking suite" }, // ⚑
  { name: "Daily Inqilab", logo: "/logo/partners/inqilab-logo.png", sector: "Media", work: "News publishing platform" }, // ⚑
  { name: "MH Group", logo: "/logo/partners/mhgroup-logo.png", sector: "Conglomerate", work: "Group intranet & HRM" }, // ⚑
  { name: "Ramy", logo: "/logo/partners/ramy-logo.png", sector: "Retail", work: "E-commerce storefront" }, // ⚑
  { name: "Vertex", logo: "/logo/partners/vertex-logo.png", sector: "Technology", work: "Brand system & website" }, // ⚑
  { name: "Wintex", logo: "/logo/partners/wintex-logo.png", sector: "Garments export", work: "Export ERP" }, // ⚑
];
