...
/* Client logos in /public/logo/partners. Real files — verified on disk.
   ...
   `sector` is the grouping EcosystemBand shows beside each logo on the
   homepage; `work` is the project label the /about client grid renders under
   the name.
   ...
   ⚑ `href` is currently read by nothing. It was PartnersBand's case-study
   link, and PartnersBand was deleted in the dead-code pass along with the rest
   of the components no route reached. Kept on the data because wiring it into
   EcosystemBand is a small, likely change; delete it if that never happens. */
