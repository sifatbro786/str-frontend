...
export const site = {
    ...
    nav: [
        ...
        /* Sits between Work and About on purpose: it is the first thing a
           ...
           anyone scrolls back up for. /packages carries the published EUR
           rates and the sample library under them.
           ⚑ /overview renders the same page and is not linked from anywhere —
           it stays reachable only for the links already sent to clients under
           that address. Do not add it here. */
