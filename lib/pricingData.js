/**
 * EUR pricing for /packages — four build tracks, three tiers each.
 *
...
export const PRICING_CATEGORIES = [
    {
        ...
        tiers: [
            ...
            },
            {
                ...
                billing: "Starting from · scoped per programme",
                timeline: "8–14 weeks",
                features: [
 ...
 * getCatalogueItems() is: the day this moves behind the dashboard, the body
